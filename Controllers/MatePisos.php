    ...
    public function registrar()
    {
        ...
        if (empty($nombre) || empty($cantidad) || empty($precioBajo) || empty($precioMedio) || empty($precioAlto)) {
            ...
            if ($id == "") {
                ...
                $data = $this->model->registrarMatePiso($nombre, $medida, $cantidad, $precioBajo, $precioMedio, $precioAlto, $totalBajo, $totalMedio, $totalAlto, $id_elemento);
                if ($data == "ok") {
                    $msg = "si";
                } else if ($data == "existe") {
                ...
                $totalMedio = ($cantidad * $precioMedio) / 100;
                $totalAlto = ($cantidad * $precioAlto) / 100;
                $data = $this->model->modificarMatePiso($nombre, $medida, $cantidad, $precioBajo, $precioMedio, $precioAlto, $id_elemento, $totalBajo, $totalMedio, $totalAlto, $id);
                if ($data == "modificar") {
                    $msg = "modificar";
                } else {
